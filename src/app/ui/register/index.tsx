            ...
            <div className="flex items-center justify-center mt-20">
                <form className="max-w-sm mx-auto">
                    <div className="mb-5">
                        ...
                        <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2" placeholder="muncher" required />
                    </div>
                    <div className="mb-5">
                    ...
                    <div className="flex items-center justify-center mb-5">
                        <label className="block mb-2 text-sm font-medium text-primary">Have an account? <b>Login</b></label>
                    </div>
                </form>
            </div>
        </div>
